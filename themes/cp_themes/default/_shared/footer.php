...
<div id="footer">
	<img src="<?=$cp_theme_url?>images/ee_logo_footer.gif" alt="<?=APP_NAME?>" width="109" height="15" />
	<?=(IS_FREELANCER)?' Freelancer':''?> v<?=APP_VER?> - &copy; <?=lang('copyright')?> 2003 - 2010 EllisLab, Inc.<br />
