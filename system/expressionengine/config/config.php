...
$config['install_lock'] = "";
$config['debug'] = '1';
$config['cp_url'] = 'http://entries.localhost:8081/system/index.php';
$config['doc_url'] = "http://dereferer.ws/?http://expressionengine.com/user_guide/";
$config['is_system_on'] = 'y';
$config['site_label'] = 'Timeline Jobsity';
