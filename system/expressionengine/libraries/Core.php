...
class EE_Core {
	...
	function _initialize_cp()
	{
		...
		if (strncmp($this->EE->config->item('doc_url'), 'http://dereferer.ws/?http://expressionengine.com/docs', 32) == 0)
		{
			$this->EE->config->update_site_prefs(array('doc_url' => 'http://dereferer.ws/?http://expressionengine.com/user_guide/'));
		}
	}
